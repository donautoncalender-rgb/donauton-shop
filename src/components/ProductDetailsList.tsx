...
export default function ProductDetailsList({ detailsJson, category, genre, sku, partsListJson }: ProductDetailsListProps) {
  ...
  // Modal JSX structure to render in portal
  ...
  return (
    <div style={{ margin: '0 0 1.5rem 0' }}>
      ...
      {/* Render modal directly in document.body to bypass relative position layouts */}
      {mounted && typeof document !== 'undefined' ? createPortal(modalJSX, document.body) : null}
    </div>
  );
}
