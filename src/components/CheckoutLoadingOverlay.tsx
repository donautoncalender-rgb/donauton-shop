...
export default function CheckoutLoadingOverlay({ isVisible }: { isVisible: boolean }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ marginBottom: '2rem', color: 'var(--primary)', animation: 'spinNoteFast 1.5s linear infinite' }}>
