...
export default function ProductCard({ product, viewMode = 'grid' }: ProductCardProps) {
  ...
  if (isList) {
    const RundelButton = ({ icon, label, onClick }: any) => (
      ...
      >
        <div className="rundel-btn-icon">
          {icon}
        </div>
        <span className="rundel-btn-label">{label}</span>
      </button>
    );
      ...
      <Link href={`/${getProductRoute(product.category)}/${product.id}`} style={{ textDecoration: 'none', color: 'inherit' }}>
        <div className="product-card-list">
          ...
          <div className="product-card-list-content">
            ...
            <div className="product-card-list-composer" style={{ color: 'var(--accent)', fontWeight: 700, fontSize: '1rem', marginBottom: '0.3rem' }}>
            ...
            {product.description && (
              <div className="product-card-list-desc" style={{ 
                fontSize: '0.95rem', 
                color: '#555', 
                lineHeight: '1.6', 
                display: '-webkit-box', 
          ...
          <div className="product-card-list-actions">
            ...
            <div className="rundel-secondary-actions">
              <RundelButton 
